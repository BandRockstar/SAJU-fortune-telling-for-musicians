...
if submitted:
    if not (y and m and d) or h_str == "시간 선택 (또는 모름)":
        ...
        <div class='music-card' style='background-color:#FFF5F7;'>
            <h2>🎹 음악적 흐름 이야기</h2>
            <div class='content-text'>
                예술가로서 {target_y}년은 본인만의 독보적인 '사운드 정체성'이 대중에게 가장 강렬하게 각인되는 확장의 시기입니다. 
                올해의 기운은 본인의 창의적인 에너지를 더욱 정교하게 정제하여 세련된 결과물로 도출하게 도우며, 특히 새로운 장르로의 도전이나 예상치 못한 아티스트와의 협업이 본인의 음악적 지평을 넓히는 결정적인 계기가 될 것입니다. 
                대규모 라이브 공연이나 중요한 음반 발표를 계획하고 있다면, 우주의 기운이 본인의 뒤를 든든하게 받쳐주고 있으니 망설임 없이 예술적 철학을 세상에 투영하시길 권장합니다. 
                단순히 유행을 따르는 소리를 넘어 시대의 흐름과 공명하는 본인만의 독창적인 선율은 청중의 영혼에 씻기지 않는 여운을 남길 것입니다. 
                또한 창작 과정에서 오는 사소한 고뇌들이 오히려 예술적 깊이를 더해주는 자양분이 되어, 본인의 음악 커리어에서 기념비적인 작품을 탄생시킬 수 있는 절호의 기회를 맞이하게 될 것입니다.
            </div>
        </div>
        """, unsafe_allow_html=True)
